...
function trimLogFile(logPath: string, maxSize: number) {
  try {
    ...
    // Keep newest lines that fit within the target size
...
// =============================================================================
// Manus Storage Proxy Vite Plugin
// =============================================================================
...
// IMPORTANT:
// jsxLocPlugin() has been removed because
// @builder.io/vite-plugin-jsx-loc is incompatible
// with Vite 7.
